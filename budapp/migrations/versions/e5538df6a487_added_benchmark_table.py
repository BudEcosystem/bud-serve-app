...
def downgrade() -> None:
    op.sync_enum_values('public', 'workflow_type_enum', ['model_deployment', 'model_security_scan', 'cluster_onboarding', 'cluster_deletion', 'endpoint_deletion', 'endpoint_worker_deletion', 'cloud_model_onboarding', 'local_model_onboarding', 'add_worker_to_endpoint', 'license_faq_fetch', 'local_model_quantization'],
        [TableReference(table_schema='public', table_name='workflow', column_name='workflow_type')],
        enum_values_to_rename=[])
    op.drop_table('benchmark')
