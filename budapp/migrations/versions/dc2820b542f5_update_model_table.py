...
Revision ID: dc2820b542f5
Revises: 64e788fd946c
Create Date: 2024-12-06 07:34:45.452306
...
def upgrade() -> None:
    ...
    op.add_column('paper_published', sa.Column('authors', sa.ARRAY(sa.String()), nullable=True))
