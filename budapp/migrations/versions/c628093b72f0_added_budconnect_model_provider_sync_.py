...
def upgrade() -> None:
    ...
    op.add_column('cloud_model', sa.Column('modality', postgresql.ARRAY(postgresql.ENUM('text_input', 'text_output', 'image_input', 'image_output', 'audio_input', 'audio_output', name='modality_enum', create_type=False)), nullable=False))
    op.add_column('model', sa.Column('modality', postgresql.ARRAY(postgresql.ENUM('text_input', 'text_output', 'image_input', 'image_output', 'audio_input', 'audio_output', name='modality_enum', create_type=False)), nullable=False))
