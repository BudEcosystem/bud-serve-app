...
def downgrade() -> None:
    ...
    op.create_unique_constraint(op.f('uq_exprawresults_evaluation'), 'exp_raw_results', ['evaluation_id'], postgresql_nulls_not_distinct=False)
    ...
    op.create_unique_constraint(op.f('uq_expmetrics_evaluation_metric_mode'), 'exp_metrics', ['evaluation_id', 'metric_name', 'mode'], postgresql_nulls_not_distinct=False)
